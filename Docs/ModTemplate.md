# City of Gangsters Mod Template

Use this template to create new mods for City of Gangsters using the automated build system.
...
2. **Update the project file** (`YourModName.csproj`):
   ...
   <ItemGroup>
     <BepInPlugin Include="mrpurple6411.cityofgangsters.yourmodname" />
     <BepInPlugin Include="Your Mod Name" />
...
4. **Add to solution**:
   ```bash
   dotnet sln CityofGangsters.sln add src/YourModName/YourModName.csproj
   ```
...
The build system uses `BepInPlugin` ItemGroup to generate plugin info:

```csharp
// Automatically generated based on your BepInPlugin ItemGroup
[BepInPlugin("mrpurple6411.cityofgangsters.yourmodname", "Your Mod Name", "1.0.0")]
...
- Keep your GUID format consistent: `mrpurple6411.cityofgangsters.modname`
